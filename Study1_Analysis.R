...
###########################################
#counterfactual plots logit P and SRS on keeper, kicker
##########################################
...
# Panel B conterfactual of SRS on keeper, kicker position held constant at 0
KeeperPer_seq <- seq(from=-6, to=6, by=0.5)
...
# Panel D conterfactual SRS on kicker, keeper position held constant at 0
Kicker_seq <- seq(from=-6, to=6, by=0.5)
